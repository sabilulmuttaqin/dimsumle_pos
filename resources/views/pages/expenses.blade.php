                ...
                <div class="p-6 border-b border-slate-200">
                    <div class="flex flex-col space-y-4">
                        ...
                        <form action="{{ route('expenses.index') }}" method="GET" class="flex flex-col md:flex-row md:items-center space-y-3 md:space-y-0 md:space-x-3">
                            ...
                            <label class="text-xs font-medium text-slate-500 mb-1">&nbsp;&nbsp;&nbsp;&nbsp;</label>
            ...
            <div class="relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <form @submit.prevent="save()">
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <h3 class="text-lg font-semibold text-slate-900 mb-4" x-text="isEdit ? 'Edit Pengeluaran' : 'Tambah Pengeluaran'"></h3>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="number" x-model="form.amount" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent" placeholder="0">
                            ...
                            <div>
                                ...
                                <input type="date" x-model="form.expense_date" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent">
                            ...
                            <div>
                                ...
                                <textarea x-model="form.description" rows="3" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent" placeholder="Masukkan Deskripsi..."></textarea>
