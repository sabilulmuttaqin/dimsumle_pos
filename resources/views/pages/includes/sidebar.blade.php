        ...
        @if (auth()->user()->isOwner())
            <div>
                ...
                <div class="space-y-1">
                    ...
                    class="sidebar-link flex items-center space-x-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('report.*') ? 'text-white bg-blue-600 hover:bg-blue-600 hover:text-white' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50 transition-colors' }}">
                    <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
